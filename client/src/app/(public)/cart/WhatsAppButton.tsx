...
interface WhatsAppButtonProps {
  /** Phone number in international format, digits only. E.g. "6281234567890" */
  phoneNumber: string;
...
function redirectToWhatsApp(phoneNumber: string, message?: string): void {
    ...
    return (
      <main className="grid place-items-center min-h-screen">
        <WhatsAppButton
          ...
          message="Hello! I found you through the website."
        />
      </main>
    );
  }
