      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="bg-card rounded-lg shadow-lg border p-8 md:p-12 space-y-8">
          ...
          <section>
            ...
            <ul className="space-y-3 ml-4">
              <li className="text-foreground leading-relaxed">
                <strong>&quot;App&quot;:</strong> Refers to GenMeta.app,
                including all its features and services.
              </li>
              <li className="text-foreground leading-relaxed">
          ...
          <section>
            ...
            <ul className="space-y-3 list-disc list-inside text-foreground ml-4">
              <li className="leading-relaxed">
                <strong>Lawful Use:</strong> Users must use the App in
                compliance with all applicable local, national, and
                international laws and regulations.
              </li>
              <li className="leading-relaxed">
                <strong>Islamic Compliance:</strong> Users are expected to
                ensure that their use of the App aligns with Islamic principles
                and does not promote or engage in activities contrary to Islamic
                teachings.
              </li>
              <li className="leading-relaxed">
                <strong>Content Ownership:</strong> Users retain ownership of
                the Content they create or upload but grant GenMeta.app a
                license to use, display, and distribute such Content as
          ...
          <section>
            ...
            <ul className="space-y-3 list-disc list-inside text-foreground ml-4">
              <li className="leading-relaxed">
                ...
                but not limited to software, design, and trademarks, are owned
                by GenMeta.app.
              </li>
              <li className="leading-relaxed">
                Users may not use GenMeta.app&apos;s intellectual property
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              GenMeta.app is provided &quot;as is&quot; without warranties of
              any kind. We are not liable for any damages arising from the use
              or inability to use the App, including but not limited to direct,
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              ...
              these terms shall be resolved in the competent courts of
              Bangladesh.
            </p>
          </section>
