      ...
      <div className="bg-background rounded-lg shadow-md p-6 md:p-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-muted-foreground">
            At GenMeta, we are committed to customer satisfaction. This Return &
            Refund Policy outlines the terms and conditions for refunds on our
            digital services and products. Please read this policy carefully
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className="space-y-2 pl-6 list-disc text-muted-foreground">
                <li>
                  ...
                  within 7 days of your initial purchase or subscription
                  renewal.
                </li>
                <li>
                  Refunds are only applicable if you have used less than 20% of
                  your allocated credits or processing quota.
                </li>
                <li>
                  Refund requests must be submitted through our support email
                  with a valid reason.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 pl-6 list-disc text-muted-foreground">
                <li>
                  Credit packages are refundable within 7 days of purchase if
                  less than 10% of the credits have been used.
                </li>
                <li>
                  Unused credits do not expire and can be used at any time, so
                  refunds are only granted in exceptional circumstances.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 pl-6 list-disc text-muted-foreground">
                <li>
                  Desktop application licenses are refundable within 14 days of
                  purchase if you experience technical issues that cannot be
                  resolved by our support team.
                </li>
                <li>
                  You must provide evidence of the technical issue and
                  demonstrate that you have worked with our support team to
                  resolve it.
                </li>
              </ul>
            </div>
        ...
        <section className="mb-8">
          ...
          <ul className="space-y-2 pl-6 list-disc text-muted-foreground">
            <li>
              After the applicable refund period has expired (7 days for
              subscriptions and credits, 14 days for desktop application).
            </li>
            <li>
              If you have violated our Terms and Conditions or engaged in
              prohibited activities.
            </li>
            <li>
              If you have used more than the allowed percentage of credits or
              services as specified in the eligibility criteria.
            </li>
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <ol className="space-y-3 pl-6 list-decimal">
              ...
              <li>
                ...
                order/transaction ID, purchase date, and a detailed reason for
                the refund request.
              </li>
              <li>
                <strong>Wait for Review:</strong> Our team will review your
                request within 2-3 business days and respond with a decision.
              </li>
              <li>
        ...
        <section className="mb-8">
          ...
          <ul className="space-y-2 pl-6 list-disc text-muted-foreground">
            <li>
              <strong>Credit/Debit Card:</strong> 5-7 business days after
              approval
            </li>
            <li>
              <strong>Mobile Banking (bKash, Nagad, Rocket):</strong> 2-3
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3 text-muted-foreground">
            <p>
              <strong>Subscription Cancellation:</strong> You may cancel your
              subscription at any time from your account dashboard. Upon
              cancellation:
            </p>
            <ul className="space-y-2 pl-6 list-disc">
              <li>
                You will retain access to your subscription benefits until the
                end of your current billing period.
              </li>
              <li>
                No refund will be provided for the remaining days of your
                current billing cycle (unless within the 7-day refund period).
              </li>
              <li>
                Your subscription will not auto-renew for the next billing
                period.
              </li>
            </ul>
          </div>
        ...
        <section className="mb-8">
          ...
          <p className="text-muted-foreground">
            In certain circumstances, we may offer partial refunds at our
            discretion. This may include situations where you have used a
            portion of the service but experienced significant issues that
            affected your ability to use the full service. Partial refund
        ...
        <section className="mb-8">
          ...
          <p className="text-muted-foreground mb-4">
            If you initiate a chargeback with your payment provider without
          ...
          <ul className="space-y-2 pl-6 list-disc text-muted-foreground">
            ...
            <li>
              We encourage you to contact us first to resolve any billing
        ...
        <section className="mb-8">
          ...
          <p className="text-muted-foreground">
            GenMeta reserves the right to modify this Return & Refund Policy at
