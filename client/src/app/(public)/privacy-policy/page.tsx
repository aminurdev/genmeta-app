        ...
        <div className="bg-card rounded-lg shadow-lg border p-8 md:p-12 space-y-8">
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed mt-4">
              ...
              protect information when you use the GenMeta application, website,
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed mb-4">
              GenMeta uses <strong>PayStation</strong> as a payment service
              provider for payments made through our website.
            </p>
            <p className="text-foreground leading-relaxed mb-3">
            ...
            <p className="text-foreground leading-relaxed mt-4">
              Payment card or other sensitive payment credentials are processed
              by the payment provider and are not intentionally stored by
              GenMeta unless explicitly stated otherwise.
            </p>
            <p className="text-foreground leading-relaxed mt-4">
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed mb-4">
              GenMeta is designed to process your files{" "}
            ...
            <p className="text-foreground leading-relaxed mb-4 font-medium">
              GenMeta does not upload or store your selected files on our
              servers as part of normal application processing.
            </p>
            <p className="text-foreground leading-relaxed mb-4">
            ...
            <p className="text-foreground leading-relaxed">
              ...
              processing to third-party AI services when a feature requires it.
              See the <strong>AI Services</strong> section below.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed mb-4">
              GenMeta currently uses <strong>Google Gemini</strong> and may use
              additional third-party AI or machine-learning services in the
              future to provide AI-powered features.
            </p>
            <p className="text-foreground leading-relaxed mb-4">
              Depending on the feature being used, information required to
              generate an AI result may be transmitted to the applicable AI
              service.
            </p>
            <p className="text-foreground leading-relaxed mb-4">
            ...
            <p className="text-foreground leading-relaxed mt-4">
              For information about Google&apos;s handling of data, please
              review Google&apos;s applicable privacy documentation.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed mb-4">
              We use <strong>Google Analytics</strong> to understand how users
              interact with our website and services and to improve GenMeta.
            </p>
            <p className="text-foreground leading-relaxed mb-3">
            ...
            <p className="text-foreground leading-relaxed mt-4">
              ...
              and to help us understand product usage and improve our services.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-foreground ml-4">
              ...
              <li>
                Hosting, infrastructure, security, or other technical service
                providers
              </li>
              <li>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              ...
              security. We therefore cannot guarantee that information will
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed mt-4">
              ...
              it in accordance with our data-retention practices and applicable
              laws.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed mb-4">
              ...
              anonymize associated personal information, except information that
              we are required or permitted to retain for legitimate purposes,
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed mt-4">
              ...
              although some website functionality may not work correctly if
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed">
              ...
              us without appropriate authorization, please contact us so that we
          ...
          <section>
            ...
            <p className="text-foreground leading-relaxed mt-4">
              We may add or change service providers as GenMeta evolves. When
              such changes materially affect how personal information is
              processed, we may update this Privacy Policy.
            </p>
          </section>
